...
const HeroBannerCard = ({ sitesCount }: HeroBannerCardProps) => {
    return (
        <div className='bg-[#f5f5f5] p-9 lg:p-10 xl:px-14 xl:py-14 xl:w-[600px] min-h-[245px] h-min absolute 2xl:left-48 xl:left-12 lg:left-0 lg:w-[450px] sm:w-[350px] sm:-left-[41px]'>
            <h1 className='font-bold text-3xl font-hurmeGeometricSans tracking-[-0.1px] text-customTextGray'>Top {sitesCount} Best Online Dating Sites and Apps in 2024 </h1>
